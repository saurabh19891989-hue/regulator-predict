...
- Systematic sample: step=**10.412**, start_offset=**5.206**, target n=**85**
- Threads built: **85** (ids US-FR-H-0001..US-FR-H-0085)
- RIN-collision skips (sampled slot's RIN already used by an earlier thread; advanced to next eligible doc): **0**
- Outcome classes: {"action_mixed": 55, "action_softened": 12, "withdrawn": 3, "stalled_no_action": 11, "action_tightened": 4}
- Positives (decisive_action=true): 71  Negatives/no-decisive-action: 14 (16% negative/stalled/withdrawn controls)
...
- Capped at 60: sampling_method=systematic (step=1.617, start_offset=0.808)
- Threads built: **60** (ids US-FR-C-0001..US-FR-C-0060)
- Outcome classes: {"unresolved": 53, "action_mixed": 6, "action_softened": 1}
- Positives (decisive_action=true): 7  Negatives/unresolved: 53 (88% negative/unresolved controls)
